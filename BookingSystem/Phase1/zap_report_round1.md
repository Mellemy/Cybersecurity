...
| Low | Exceeded High | http://10.0.2.15:8001 | Percentage of responses with status code 5xx | 56 % |
| Info | Informational | http://10.0.2.15:8001 | Percentage of responses with status code 2xx | 24 % |
| Info | Informational | http://10.0.2.15:8001 | Percentage of responses with status code 3xx | 3 % |
| Info | Exceeded Low | http://10.0.2.15:8001 | Percentage of responses with status code 4xx | 15 % |
| Info | Informational | http://10.0.2.15:8001 | Percentage of endpoints with content type text/css | 9 % |
| Info | Informational | http://10.0.2.15:8001 | Percentage of endpoints with content type text/html | 18 % |
| Info | Informational | http://10.0.2.15:8001 | Percentage of endpoints with content type text/javascript | 18 % |
| Info | Informational | http://10.0.2.15:8001 | Percentage of endpoints with content type text/plain | 54 % |
| Info | Informational | http://10.0.2.15:8001 | Percentage of endpoints with method GET | 90 % |
| Info | Informational | http://10.0.2.15:8001 | Percentage of endpoints with method POST | 9 % |
| Info | Informational | http://10.0.2.15:8001 | Count of total endpoints | 11    |
| Info | Informational | http://10.0.2.15:8001 | Percentage of slow responses | 1 % |
...
* URL: http://10.0.2.15:8001/register
  * Node Name: `http://10.0.2.15:8001/register ()(birthdate,password,role,username)`
  * Method: `POST`
  * Parameter: `username`
  * Attack: `/register`
  * Evidence: ``
...
* URL: http://10.0.2.15:8001/register
  * Node Name: `http://10.0.2.15:8001/register`
  * Method: `GET`
  * Parameter: ``
  * Attack: ``
...
* URL: http://10.0.2.15:8001
  * Node Name: `http://10.0.2.15:8001`
  * Method: `GET`
  * Parameter: ``
  * Attack: ``
  * Evidence: ``
...
* URL: http://10.0.2.15:8001/register
  ...
  * Other Info: `This issue still applies to error type pages (401, 403, 500, etc.) as those pages are often still affected by injection issues, in which case there is still concern for browsers sniffing pages away from their actual content type.
At "High" threshold this scan rule will not alert on client or server error responses.`
* URL: http://10.0.2.15:8001/static/footer.js
  * Node Name: `http://10.0.2.15:8001/static/footer.js`
  * Method: `GET`
  * Parameter: `x-content-type-options`
  * Attack: ``
  * Evidence: ``
  * Other Info: `This issue still applies to error type pages (401, 403, 500, etc.) as those pages are often still affected by injection issues, in which case there is still concern for browsers sniffing pages away from their actual content type.
At "High" threshold this scan rule will not alert on client or server error responses.`
* URL: http://10.0.2.15:8001/static/index.js
  * Node Name: `http://10.0.2.15:8001/static/index.js`
  * Method: `GET`
  * Parameter: `x-content-type-options`
  * Attack: ``
  * Evidence: ``
